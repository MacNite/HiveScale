...
- [ ] Make first prototype to test the design.
- [ ] Bring up the board on the bench before connecting sensors or a modem.
- [ ] Verify 3.3 V and 5 V rails under expected load.
- [ ] Verify ESP32 boot and serial monitor access.
- [ ] Verify I2C bus with RTC, SHT40/SHT4x, INA219, and MAX17048 installed.
- [ ] Verify SD card initialization with the current firmware mapping: MISO GPIO23, MOSI GPIO19.
- [ ] Verify HX711 channel 1 and channel 2 raw readings and calibration.
